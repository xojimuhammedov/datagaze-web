...
import guvohnoma from "@/public/texnological/guvohnoma.avif";
import Image from "next/image";
import sertifikat from "@/public/texnological/sertifikat.avif";
import it_sertifikat from "@/public/texnological/sertifikat_it_park.avif";
      ...
      <div className="mx-auto max-w-7xl px-6 ">
        ...
        <div className="grid  grid-cols-[1.5fr_2fr] gap-8 ">
          <div className="bg-white p-10 rounded-2xl relative h-160 flex gap-5 flex-col overflow-hidden">
            <h1 className="text-[24px]  ">Certified by the Cybersecurity</h1>
          ...
          <div className="bg-white p-10 rounded-2xl relative h-160 flex gap-5 flex-col overflow-hidden">
            <h1 className="text-[24px] ">Resident of IT Park</h1>
