        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="border rounded-2xl bg-white p-10 flex flex-col gap-10">
            <div className="border w-15 h-15 flex items-center justify-center rounded-full">
              <Image src={windows} alt="windows" className="w-6 h-6  " />
            </div>
            <div>
              <h1 className="pb-4 text-2xl font-semibold">Client Side</h1>
          ...
          <div className="border rounded-2xl bg-white p-10 flex flex-col gap-10">
            <div className="flex gap-4">
              <div className="border w-15 h-15 flex items-center justify-center rounded-full">
                <Image src={server1} alt="windows" className="w-6 h-6  " />
              </div>
              <div className="border w-15 h-15 flex items-center justify-center rounded-full">
                <Image src={server2} alt="windows" className="w-6 h-6  " />
              </div>
            </div>
            <div>
              <h1 className="pb-4 text-2xl font-semibold">Server Side</h1>
              <p className="text-muted-foreground">
