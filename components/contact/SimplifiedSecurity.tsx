      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="bg-white p-8 rounded-[30px] flex gap-8 items-center border shadow-[0px_4px_15px_0px_#0000000D]">
          ...
          <div className="flex flex-col gap-6">
            <h2 className="text-[40px] font-medium leading-none">{t("cta_section.title")}</h2>
            <p className="text-[18px] font-normal text-muted-foreground">
              {t("cta_section.description")}
            </p>
            <div className="flex gap-3">
              <Button 
                className="bg-[#2563EB] hover:bg-[#2563EB]/90 h-[40px] w-[83px] rounded-[12px] shadow-[0px_1px_2px_0px_rgba(20,21,26,0.05)] opacity-100 text-[12px] leading-[16px] font-medium text-white cursor-pointer"
