...
const Map = () => {
  return (
    <section className="w-full py-0 lg:py-10 bg-[#F9FAFB]">
      <div className="mx-auto max-w-7xl px-6">
        <div className="bg-white border p-4 lg:p-6 w-full flex justify-center items-center rounded-[20px] shadow-[0px_4px_15px_0px_#0000000D]">
          <iframe
