...
const OurImpakt = () => {
  ...
  const data = [
    {
      title: "4x",
      name: t("unreleased.stat1_name"),
      description: t("unreleased.common_desc"),
    },
    {
      title: "2x",
      name: t("unreleased.stat2_name"),
      description: t("unreleased.common_desc"),
    },
    {
      title: "4K HDR",
      name: t("unreleased.stat3_name"),
      description: t("unreleased.common_desc"),
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        ...
        <div className="bg-white p-6 lg:p-12 rounded-2xl border flex relative min-h-72 lg:min-h-[550px] overflow-hidden">
          <div className="flex flex-col gap-6 justify-center">
            ...
            <h3 className="font-semibold text-lg lg:text-xl">{t("unreleased.better_photos")}</h3>
            <p className="font-normal text-sm lg:text-lg text-muted-foreground w-full lg:w-150">
              {t("unreleased.better_photos_desc")}
            </p>
